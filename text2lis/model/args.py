...
parser.add_argument('--optimizer', type=str, default='Adam', help='which optimizer to use? currently only Adam, SGD are supported')

# Data Arguments
# parser.add_argument('--max_seq_size', type=int, default=10000, help='input sequence size')
...
#                                                               'options are: ["pjm", "dgs", "gsl", "lsf"].'
#                                                               'Default- use all languages.')
...
parser.add_argument('--num_steps', type=int, default=1, help='number of pose refinement steps')
parser.add_argument('--separate_positional_embedding', type=bool, default=True, help='separate positional embeddings between text and pose?')
...
parser.add_argument('--ckpt', type=str, default="checkpoints", metavar='PATH', help="Checkpoints directory name inside model directory")
parser.add_argument('--output_dir', type=str, default="videos", metavar='PATH', help="output videos directory name inside model directory")
